...
return (new CustomEvent(event_name,(function (){var obj29045 = ({"detail":data});
return obj29045;
})()));
} else {
...
var f = (function (){var pred__29052 = cljs.core._EQ_;
var expr__29053 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29052.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29053))){
return (function (p1__29046_SHARP_){
return console.warn(p1__29046_SHARP_);
});
} else {
if(cljs.core.truth_(pred__29052.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29053))){
return (function (p1__29047_SHARP_){
return console.debug(p1__29047_SHARP_);
});
} else {
if(cljs.core.truth_(pred__29052.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29053))){
return (function (p1__29048_SHARP_){
return console.error(p1__29048_SHARP_);
});
} else {
return (function (p1__29049_SHARP_){
return console.log(p1__29049_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29056){
...
var eval_fn = cljs.core.get.call(null,map__29057__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__29059_SHARP_){
return new_def.callback(p1__29059_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__29060){
var vec__29061 = p__29060;
var ky = cljs.core.nth.call(null,vec__29061,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1608325372689
