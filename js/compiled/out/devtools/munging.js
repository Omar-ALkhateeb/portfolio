...
var o26868 = temp__5718__auto__;
var temp__5718__auto____$1 = (o26868["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o26869 = temp__5718__auto____$1;
return (o26869["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26226__auto__ = f;
return (o__26226__auto__["toString"]).call(o__26226__auto__);
} else {
return "";
}
}catch (e26870){var _ = e26870;
return "";
}});
...
try{var o__26226__auto___26872 = t;
(o__26226__auto___26872["cljs$lang$ctorPrWriter"]).call(o__26226__auto___26872,t,writer);
}catch (e26871){var __26873 = e26871;
}
...
var char_code = (function (){var o__26226__auto__ = (new String(char$));
return (o__26226__auto__["charCodeAt"]).call(o__26226__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26226__auto__ = String;
return (o__26226__auto__["fromCharCode"]).call(o__26226__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26874 = num_code;
switch (G__26874) {
case (1):
return (185);
...
var o__26226__auto__ = String;
return (o__26226__auto__["fromCharCode"]).call(o__26226__auto__,superscript_code);
});
/**
...
}catch (e26876){var _e__26233__auto__ = e26876;
return false;
}})())){
...
var vec__26877 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26877,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o26880 = temp__5718__auto__;
var temp__5718__auto____$1 = (o26880["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o26881 = temp__5718__auto____$1;
return (o26881["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26884){
var vec__26885 = p__26884;
var ns_detector = cljs.core.nth.call(null,vec__26885,(0),null);
...
var G__26891 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26892 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26891;
remaining_tokens = G__26892;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26882){
var G__26883 = cljs.core.first.call(null,seq26882);
var seq26882__$1 = cljs.core.next.call(null,seq26882);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26883,seq26882__$1);
}));
...
var vec__26896 = cljs.core.split_with.call(null,(function (p1__26895_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26895_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26896,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26896,(1),null);
...
var vec__26902 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26902,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26902,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26905 = cljs.core.rest.call(null,remaining_tokens);
var G__26906 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26905;
name_tokens = G__26906;
continue;
} else {
...
var vec__26909 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26909,(0),null);
var arity = cljs.core.nth.call(null,vec__26909,(1),null);
var vec__26912 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26912,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26912,(1),null);
var vec__26915 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26915,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26915,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26915,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26915,(3),null);
...
var vec__26921 = result;
var munged_ns = cljs.core.nth.call(null,vec__26921,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26921,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26921,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26921,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26921,(4),null);
var arity = cljs.core.nth.call(null,vec__26921,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__26925 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__26925,(0),null);
var args = cljs.core.nth.call(null,vec__26925,(1),null);
var vec__26928 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26928,(0),null);
var name = cljs.core.nth.call(null,vec__26928,(1),null);
...
var G__26931 = (arity + (1));
var G__26932 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26933){
var vec__26934 = p__26933;
var arity = cljs.core.nth.call(null,vec__26934,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26934,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__26937_SHARP_){
return cljs.core.get.call(null,arities,p1__26937_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__26938_SHARP_){
return cljs.core.drop.call(null,(2),p1__26938_SHARP_);
}),sorted_infos);
...
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26942,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26939){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26950__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26950__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26950__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26950__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26951 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26951,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26951,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26951,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26951,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26951,(4),null);
var arity = cljs.core.nth.call(null,vec__26951,(5),null);
...
var o__26226__auto__ = f;
return (o__26226__auto__["getBasis"]).call(o__26226__auto__);
});
/**
...
}catch (e26955){var _e__26233__auto__ = e26955;
...
var G__26956 = (obj[cljs.core.first.call(null,path)]);
var G__26957 = cljs.core.rest.call(null,path);
obj = G__26956;
path = G__26957;
continue;
} else {
...
var _STAR_ = (function (accum,p__26958){
var vec__26959 = p__26958;
var bit = cljs.core.nth.call(null,vec__26959,(0),null);
var protocol = cljs.core.nth.call(null,vec__26959,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26962){
var vec__26963 = p__26962;
var ns = cljs.core.nth.call(null,vec__26963,(0),null);
var name = cljs.core.nth.call(null,vec__26963,(1),null);
var selector = cljs.core.nth.call(null,vec__26963,(2),null);
...
var post_process = (function (p__26967){
var vec__26968 = p__26967;
var munged_name = cljs.core.nth.call(null,vec__26968,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26968,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__26966_SHARP_){
return (obj[cljs.core.first.call(null,p1__26966_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1608325368885
