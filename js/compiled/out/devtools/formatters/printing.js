...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq26999){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27000,G__27001,seq26999__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27005_SHARP_){
return (!((cljs.core.meta.call(null,p1__27005_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__27006__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27010){var _e__26233__auto__ = e27010;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e27012){var _e__26233__auto__ = e27012;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27014 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27015 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27015);

try{var map__27016 = opts;
...
var markup_db = cljs.core.get.call(null,map__27016__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27014);
}});
...
var temp__5718__auto___27021 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___27021)){
var managed_print_level_27022 = temp__5718__auto___27021;
var _STAR_print_level_STAR__orig_val__27019_27023 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27020_27024 = managed_print_level_27022;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27020_27024);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__27018_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__27018_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27019_27023);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1608325369430
