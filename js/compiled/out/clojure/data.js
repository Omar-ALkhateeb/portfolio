...
return cljs.core.reduce.call(null,(function (result,p__28315){
...
var vec__28319 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__28319,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__28319,(1),null);
var ab = cljs.core.nth.call(null,vec__28319,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_28325 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_28325.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_28326 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_28326.call(null,a,b);
}
});
...
return (function (){var G__28330 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28330__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1608325371183
